...
class VFH:
    ...
    def get_command(self, force=False, debug=False, trace=None):
        ...
        arrive_thresh = MIDPOINT_DIST_THRESHOLD if self.midpoint else TARGET_DIST_THRESHOLD
    ...
    def debug_snapshot(self):
        ...
        target_dist = np.linalg.norm(goto[:2] - pos[0:2])
        print(f"TARGET={goto[:2]} POS={pos[:2]} ROT={round(rot[2] / math.pi * 180)} DIST={target_dist}")
